...
extension UserModelPatterns on UserModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String name, String username, String email,
    ...
    switch (_that) {
      case _UserModel() when $default != null:
        return $default(_that.id, _that.name, _that.username, _that.email,
            _that.phone, _that.website);
      case _:
        return orElse();
    }
  }
